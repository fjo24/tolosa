...
@section('titulo', 'Listado de imagenes de '.$modelo->nombre)
...
<main>
    <div class="container">
        ...
        <div class="row">
            <div class="row">
                {!!Form::open(['route'=>['newimagenmodelo', $modelo->id], 'method'=>'POST', 'files' => true])!!}
                <div class="row">
                ...
                <table class="highlight bordered">
                    ...
                    @foreach($imagenes as $imagen)
                        <tr>
                            ...
                            <td class="text-right">
                                   {!!Form::open(['class'=>'en-linea', 'route'=>['imgmodelo.destroy', $imagen->id], 'method' => 'DELETE'])!!}
