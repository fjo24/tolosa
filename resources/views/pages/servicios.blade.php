         ...
         <div class="row"  style="align-items: center;">
            ...
            <div class="col l12 s12 m12">
               @foreach($servicios as $servicio)  
                     <div class="col l3 s12 m6" style="margin:20px 0px;">
                          <div class="card" style="background-color: #32398E;">
                            <div class="card-panel"  style="border:0px;background-color: #32398E; height: 300px; padding-top: 20px;">
                              <span class="activator" style="color: white; justify-content: center; align-items: center;"><img style="padding: auto;width: 60%;height: 50%;align-items: center;" class="responsive-img" src="{{asset($servicio->imagen)}}" alt="">
                              </span>
                              <hr>
